 ...
 */
final class Version20210701120055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__duck AS SELECT id, email, roles, password, is_verified, lastname, duckname FROM duck');
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, is_verified BOOLEAN NOT NULL, lastname VARCHAR(255) NOT NULL COLLATE BINARY, duckname VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO duck (id, email, roles, password, is_verified, lastname, duckname) SELECT id, email, roles, password, is_verified, lastname, duckname FROM __temp__duck');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE duck ADD COLUMN firstname VARCHAR(255) NOT NULL COLLATE BINARY');
